<template>
  <v-container fill-height>
    <v-row>
      <v-col cols="12" sm="6">
        <div class="text-h1 font-weight-black">{{ pageNotFound }}</div>
        <div class="text-h6 font-weight-black red--text">
          {{ error.message }}
        </div>
        <p class="text-h6 headline">
          Desculpe, houve um erro acessando a página.
        </p>
        <p class="mb-8">
          Mas não se preocupe, clique no botão baixo para voltar a página
          principal.
        </p>

        <v-btn tile outlined depressed color="primary" nuxt to="/">
          Página Principal
        </v-btn>
      </v-col>
      <v-col cols="12" sm="6">
