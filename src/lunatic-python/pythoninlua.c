/*
 ...
 Update history:
 20161210	mvh	Added __add, __sub, __mul, __div, __pow operators
 20161210	mvh	Indexing a python object by number gives same behavior as asindx
 20161210	mvh	Added named parameters, e.g. call(1, 2) --> call{1, 2, c='red'}
 20161211	mvh	Put in pull request on github
 20161213	mvh	Retrieved merge from github
 20203014	mvh	Went back to version from bastibe on Github
			Modified lua calls for 5.1 compatibility; compatibility with Python3.x
			Fixed calls like ax.plt{} and ax.set{xlabel='test', ylabel='new'}, added nargs=0
 20203016	mvh	Added GetAttr if GetItem fails
 */
#include <Python.h>
