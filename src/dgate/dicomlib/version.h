...
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/WIN32"
#else
#ifdef	ULTRIXMIPS
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/UMIPS"
#else
#ifdef	SOLARIS
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/SL5"
#else
#ifdef	MAC
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/MAC"
#else
#ifdef	SUNOSSPARC
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/SUNOS"
#else
#ifdef	DARWIN
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/OSX"
#else
#	define	IMPLEMENTATION_VERSION_STRING	"1.4.19/OTHER"
#endif
#endif
#endif
#endif
