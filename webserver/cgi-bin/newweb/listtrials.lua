...
for i=1,#trials do
  t = string.format("<a href=dgate%s?%s&mode=listtrialpatients&key=%s&trial=%s title='click to see trial patients'>%s</a>", ex, extra, tostring(key or ''),trials[i],trials[i]);
